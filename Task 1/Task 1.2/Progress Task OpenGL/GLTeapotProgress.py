...
def drawGLScene():
        ...
        if ret == True:
                ...
                for i in ar_list:
                       if i[0] == 0:
                                overlay(frame, ar_list, i[0], 'waterpitcher(low1).obj')
                       if i[0] == 1:
                                overlay(frame, ar_list, i[0], 'crow.obj')
##                       if i[0] == 7:
